...
namespace StableFluids
{
    public class Fluid2 : MonoBehaviour
    {
        ...
        [SerializeField] float _sourceDistance = 0.1f; // percentage of screen
        ...
        {
            VFB.D0 = AllocateBuffer(4);
            VFB.D1 = AllocateBuffer(4);
            VFB.D2 = AllocateBuffer(4);
            VFB.D3 = AllocateBuffer(4);
            VFB.V1 = AllocateBuffer(4);
